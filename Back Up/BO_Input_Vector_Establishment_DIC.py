...
if __name__ == "__main__":
    ...
    LIB_ROOT = r"C:\Users\Tungtan\PycharmProjects\AutomationDesign\Component Library"
    ...
    if Input_Matrix_Re_Build == 1:
        ...
        if Input_Matrix_Re_Build == 1:
            ...
            fixed_indices = np.random.choice(np.arange(1, Z_index.shape[0]+1), size=int(Z_index.shape[0]*0.075), replace=False)
