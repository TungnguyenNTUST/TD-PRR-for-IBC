...
Frequency_list = {1:20e3, 2:30e4, 3:40e3, 4:50e3, 5:60e3, 6:70e3, 7:80e3, 8:90e-3, 9:100e-3, 10:110e3}
...
# # Log-scale x cannot include 0 → start from a small positive value
# H = np.logspace(-1, 3, 1000)  # from 1e-3 to 1e3
# muy = 100 / (1 + b * H**c)
# plt.figure(figsize=(8, 5))
# plt.semilogx(H, muy, label=r'$\mu(H) = \dfrac{100}{1 + b\,H^c}$')
# plt.xlabel("H (log scale)")
# plt.ylabel("μ (muy)")
# plt.title("μ vs H (log x-axis)")
